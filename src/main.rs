    ...
    for cell_row in grid.get_cells()
    {
        for cell in cell_row
        {
            if cell.is_alive()
            {
                ...
                let rect_width = constants::gui_constants::WINDOW_SIZE_X /constants::game_constants::NUMBER_OF_CELLS_X as usize;
                let rect_height = constants::gui_constants::WINDOW_SIZE_Y / constants::game_constants::NUMBER_OF_CELLS_Y as usize;
                
                draw_rectangle(x as f32, y as f32, rect_width as f32, rect_height as f32, constants::gui_constants::CELL_COLOR);
            }
        }
    }
}
...
async fn main() {
    ...
    let mut grid = game_model::grid::Grid::new(constants::game_constants::NUMBER_OF_CELLS_X,
    ...
    loop {
        ...
        let one_sec = time::Duration::from_millis(constants::game_constants::REFRESH_RATE_MS as u64);
