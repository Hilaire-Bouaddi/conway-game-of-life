...
impl Grid
{
    pub fn new(number_of_cells_x: GridDimensionsIntegerType, number_of_cells_y: GridDimensionsIntegerType) -> Grid
    {
    ...
    pub fn update_cells(&mut self)
    {
        ...
        for y in 0..self.number_of_cells_y {
            ...
            for x in 0..self.number_of_cells_x
            {
                let number_of_neighbors = count_neighbors(&self.cells[y as usize][x as usize], &self.cells);
        ...
        self.cells.iter_mut()
            .for_each(|cell_row| cell_row.iter_mut()
    ...
    pub fn get_number_of_cells_x_y(&self) -> (GridDimensionsIntegerType, GridDimensionsIntegerType)
    {
